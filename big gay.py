    ...
    def moveEnemy(self):
        ...
        if self.alive == True:
            if self.dist < 100:
                ...
                # print("slope:   " + str(self.slope))
                enemy = pygame.transform.rotate(pygame.transform.scale(pygame.transform.flip(pygame.image.load(full_path("/enemy" + str(self.type) + "/enemy" + str(self.frame) +".png")),True,False),(100,100)),self.slope)
                #end of test code
